...
var enumSlices = map[string]string{
	...
	"clinical.Severity":            "severities",
	"clinical.ConditionStatus":     "conditionStatuses",
	"clinical.OrderStatus":         "orderStatuses",
	"clinical.Laterality":          "lateralities",
	"clinical.InjuryType":          "injuryTypes",
	"clinical.ImmunizationRoute":   "immunizationRoutes",
	"clinical.ImmunizationSite":    "immunizationSites",
	"clinical.ProcedureSetting":    "procedureSettings",
	"clinical.ProcedureType":       "procedureTypes",
	"clinical.ProcedureOutcome":    "procedureOutcomes",
	"clinical.Anesthesia":          "anesthesias",
	"clinical.VisitType":           "visitTypes",
	"clinical.VisitPriority":       "visitPriorities",
	"clinical.TreatmentSetting":    "treatmentSettings",
	"clinical.SymptomCategory":     "symptomCategories",
	"clinical.SymptomImpact":       "symptomImpacts",
	"clinical.GlucoseContext":      "glucoseContexts",
	"clinical.InsuranceType":       "insuranceTypes",
	"clinical.InsuranceStatus":     "insuranceStatuses",
	"clinical.HolderRelationship":  "holderRelationships",
