...
export MEDIKUBE_FILES_PHOTO_MAX_BYTES=15728640    # 15 MiB
export MEDIKUBE_FILES_PHOTO_MIME_TYPES=image/jpeg,image/png,image/webp
export MEDIKUBE_FILES_PHOTO_THUMBS=100x100t,400x400f
```
